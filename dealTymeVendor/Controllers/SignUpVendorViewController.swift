...
class SignUpVendorViewController: UIViewController {
...
//        view.backgroundColor = .green
    ...
    let contactNameTextField: UITextField = {
        ...
        tf.attributedPlaceholder = NSAttributedString(string: "Contact Name",
    ...
    let businessNameTextField: UITextField = {
        let tf = UITextField()
        tf.font = .systemFont(ofSize: 14)
        tf.attributedPlaceholder = NSAttributedString(string: "Business Name",
                                                      attributes: [NSAttributedString.Key.foregroundColor: UIColor.lightGray])
        tf.autocorrectionType = .no
        tf.backgroundColor = .white
        tf.textAlignment = .left
    ...
    let addressTextField: UITextField = {
        let tf = UITextField()
        tf.font = .systemFont(ofSize: 14)
        tf.attributedPlaceholder = NSAttributedString(string: "Address",
                                                      attributes: [NSAttributedString.Key.foregroundColor: UIColor.lightGray])
        tf.autocorrectionType = .no
    ...
    let contactEmailTextField: UITextField = {
        let tf = UITextField()
        tf.font = .systemFont(ofSize: 14)
        tf.attributedPlaceholder = NSAttributedString(string: "Contact Email",
                                                      attributes: [NSAttributedString.Key.foregroundColor: UIColor.lightGray])
        tf.autocorrectionType = .no
        tf.isSecureTextEntry = true
        tf.backgroundColor = .white
    ...
    let typeOfBusinessTextField: UITextField = {
        let tf = UITextField()
        tf.font = .systemFont(ofSize: 14)
        tf.attributedPlaceholder = NSAttributedString(string: "Type of Business",
                                                      attributes: [NSAttributedString.Key.foregroundColor: UIColor.lightGray])
        tf.autocorrectionType = .no
        tf.isSecureTextEntry = true
        tf.backgroundColor = .white
    ...
    let typeOfCuisineTextField: UITextField = {
        let tf = UITextField()
        tf.font = .systemFont(ofSize: 14)
        tf.attributedPlaceholder = NSAttributedString(string: "Type of Cuisine",
                                                      attributes: [NSAttributedString.Key.foregroundColor: UIColor.lightGray])
        tf.autocorrectionType = .no
        tf.isSecureTextEntry = true
        tf.backgroundColor = .white
...
//        self.navigationController?.pushViewController(CodeVerificationViewController(), animated: true)
        ...
        if !(contactNameTextField.text?.isEmpty)! && !(businessNameTextField.text?.isEmpty)! && !(addressTextField.text?.isEmpty)! && !(phoneNumberTextField.text?.isEmpty)!{
...
//========================================================================
    ...
    func setupViews(){
        ...
        logoContainerView.heightAnchor.constraint(equalTo: mainView.heightAnchor, multiplier: 0.15).isActive = true
        ...
        inputsContainerView.heightAnchor.constraint(equalTo: mainView.heightAnchor, multiplier: 0.7).isActive = true
        ...
        bottomView.heightAnchor.constraint(equalTo: mainView.heightAnchor, multiplier: 0.15).isActive = true
        ...
        inputsContainerView.addSubview(contactNameTextField)
        contactNameTextField.widthAnchor.constraint(equalTo: inputsContainerView.widthAnchor, constant: -100).isActive = true
        contactNameTextField.heightAnchor.constraint(equalToConstant: 30).isActive = true
        contactNameTextField.centerXAnchor.constraint(equalTo: inputsContainerView.centerXAnchor).isActive = true
        contactNameTextField.topAnchor.constraint(equalTo: inputsContainerView.topAnchor, constant: 25).isActive = true
        
        inputsContainerView.addSubview(lineSeparator2)
        lineSeparator2.topAnchor.constraint(equalTo: contactNameTextField.bottomAnchor, constant: 5).isActive = true
        ...
        inputsContainerView.addSubview(businessNameTextField)
        businessNameTextField.widthAnchor.constraint(equalTo: inputsContainerView.widthAnchor, constant: -100).isActive = true
        businessNameTextField.heightAnchor.constraint(equalToConstant: 30).isActive = true
        businessNameTextField.centerXAnchor.constraint(equalTo: logoContainerView.centerXAnchor).isActive = true
        businessNameTextField.topAnchor.constraint(equalTo: lineSeparator2.bottomAnchor, constant: 20).isActive = true
        
        inputsContainerView.addSubview(lineSeparator3)
        lineSeparator3.topAnchor.constraint(equalTo: businessNameTextField.bottomAnchor, constant: 5).isActive = true
        ...
        addressTextField.widthAnchor.constraint(equalTo: inputsContainerView.widthAnchor, constant: -100).isActive = true
        addressTextField.heightAnchor.constraint(equalToConstant: 30).isActive = true
        addressTextField.centerXAnchor.constraint(equalTo: logoContainerView.centerXAnchor).isActive = true
        addressTextField.topAnchor.constraint(equalTo: lineSeparator3.bottomAnchor, constant: 20).isActive = true
        
        inputsContainerView.addSubview(lineSeparator4)
        lineSeparator4.topAnchor.constraint(equalTo: addressTextField.bottomAnchor, constant: 5).isActive = true
        ...
        phoneNumberTextField.topAnchor.constraint(equalTo: lineSeparator4.bottomAnchor, constant: 20).isActive = true
        
        inputsContainerView.addSubview(lineSeparator5)
        lineSeparator5.topAnchor.constraint(equalTo: phoneNumberTextField.bottomAnchor, constant: 5).isActive = true
        ...
        inputsContainerView.addSubview(contactEmailTextField)
        contactEmailTextField.widthAnchor.constraint(equalTo: inputsContainerView.widthAnchor, constant: -100).isActive = true
        contactEmailTextField.heightAnchor.constraint(equalToConstant: 30).isActive = true
        contactEmailTextField.centerXAnchor.constraint(equalTo: logoContainerView.centerXAnchor).isActive = true
        contactEmailTextField.topAnchor.constraint(equalTo: lineSeparator5.bottomAnchor, constant: 20).isActive = true
        
        inputsContainerView.addSubview(lineSeparator6)
        lineSeparator6.topAnchor.constraint(equalTo: contactEmailTextField.bottomAnchor, constant: 5).isActive = true
